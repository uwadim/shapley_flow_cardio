# Определение взаимного влияния признаков при риске ранней послеоперационной летальности у пациентов, перенесших оперативное лечение по поводу патологии аортального клапана с помощью Shapley Flow
